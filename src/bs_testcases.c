...
/* `extern` is essential: this file is compiled as C++ (-x c++), where a
   file-scope `const` would otherwise get internal linkage and be invisible
   to other translation units (e.g. selfTest in main.cpp). */
...
/* dead leftover from the old C main: currentkey32 = 0x00 << 24 | 0x111 << 16 | 0x33 << 8 | 0x44; */
static unsigned char probedata[3][16] = { 
